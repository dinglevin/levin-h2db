...
import levin.h2.message.DbException;
import org.h2.result.Row;
import levin.h2.schema.Schema;
import levin.h2.schema.Sequence;
import levin.h2.util.MathUtils;
import levin.h2.util.StringUtils;
import levin.h2.value.DataType;
import levin.h2.value.Value;
import levin.h2.value.ValueDate;
import levin.h2.value.ValueInt;
import levin.h2.value.ValueLong;
import levin.h2.value.ValueNull;
import levin.h2.value.ValueString;
import levin.h2.value.ValueTime;
import levin.h2.value.ValueTimestamp;
import levin.h2.value.ValueTimestampUtc;
import levin.h2.value.ValueUuid;
